                  ...
                  <div ref={scrollContentRef} className="w-screen flex flex-col">
                    ...
                    <Section className="items-end text-right">
                      ...
                      <h1 className="text-4xl md:text-7xl font-black uppercase leading-tight max-w-4xl">
                        ...
                        <span className="text-gray-400 text-3xl md:text-5xl">For Visionaries Who Demand Excellence.</span>
                      </h1>
                    ...
                    <Section className="items-center">
                      <div className="w-full max-w-7xl px-6">
                        <div className="flex flex-col mb-20">
                          ...
                          <p className="text-white/60 text-xs font-mono uppercase tracking-widest">Engineered for 2026 // Performance First</p>
                        </div>
