...
export default function Overlay() {
  ...
  return (
    <div className="w-screen text-[#f0f0f0] font-sans selection:bg-red-600 selection:text-white">
      
      {/* 1. INTRODUCTION - THE BRAND */}
      <Section>
        <div className="border-l-4 border-red-600 pl-6 md:pl-10 animate-slide-left">
          ...
          <p className="text-gray-500 font-mono tracking-widest uppercase mt-6 text-[10px] md:text-lg border-t border-white/10 pt-4 inline-block">
            Full-Stack Engineer Performance & Conversion Specialist    </p>
        </div>
      </Section>

      {/* 2. ABOUT - THE VALUE PROPOSITION */}
      <Section className="items-end text-right">
        ...
        <div className="max-w-2xl mt-8 space-y-6 text-gray-400 font-light text-base md:text-xl leading-relaxed">
          ...
          <p>
            ...
            My work focuses on three pillars:
            Performance. Visibility. Control.

            You’re not just hiring a developer.
            You’re investing in a scalable digital asset.
        
          </p>
        </div>
      </Section>

      {/* 3. PROJECTS - THE PORTFOLIO */}
        <Section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
            ...
            /* 1. Added pointer-events-auto so the link is clickable through the Canvas */
            /* 2. Added target="_blank" so users don't lose your 3D site when clicking */
            <a 
                href={item.link} 
                key={i} 
                target="_blank" 
...
{/* 4. SERVICES - THE INVESTMENT */}
<Section className="items-center">
  <div className="w-full max-w-7xl px-6">
    <div className="flex flex-col mb-20">
      <h2 className="text-red-600 text-sm font-mono uppercase tracking-[0.3em] mb-4">
        — Exclusive Solutions
      </h2>
      <p className="text-white/40 text-xs font-mono uppercase tracking-widest">
        Engineered for 2026 // Performance First
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-1">
      ...
      <Section className="text-center">
        ...
        {/* Tagline */}
            ...
            <p className="text-gray-500 font-mono uppercase tracking-[0.3em] text-[10px] md:text-xs text-center">
      ...
      {/* 6. PHILOSOPHY — OPERATIONAL DOCTRINE */}
        ...
        <div className="max-w-4xl">
            ...
            <p className="text-gray-500 font-mono uppercase tracking-[0.3em] text-[10px] md:text-xs mb-4">
            ...
            <div className="space-y-4 font-mono text-sm uppercase">
              <a href="mailto:kastriootaliiu@gmail.com" className="block text-red-600 hover:text-white transition-colors border-b border-red-600/20 pb-2 w-fit italic">kastriootaliiu@gmail.com</a>
                ...
                <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-gray-500 hover:text-white cursor-pointer transition-colors font-mono text-xs uppercase tracking-widest"
                >
                    GitHub
                </a>
                <a 
